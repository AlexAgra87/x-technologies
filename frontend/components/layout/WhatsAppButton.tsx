...
export function WhatsAppButton() {
    ...
    // Use centralized phone number
    const phoneNumber = siteSettings.contact.whatsapp

    const handleSend = () => {
        const text = message.trim() || 'Hi! I have a question about your products.'
                    ...
                    >
                        ...
                        <div className="bg-[#25D366] px-4 py-4 flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="text-white font-semibold">X-Technologies</h3>
                        ...
                        <div className="p-4 bg-[#E5DDD5] min-h-[180px]">
                            ...
                            <div className="bg-white rounded-lg rounded-tl-none p-3 shadow-sm max-w-[85%]">
                                ...
                                <p className="text-gray-500 text-xs mt-1">
                                    Ask us about products, stock, pricing, or anything else!
                                </p>
                            </div>
                        </div>
